const BASE_URL = "https://api.coingecko.com/api/v3"; // CoinGecko API base - all endpoints start here

// Fetches top 100 cryptocurrencies sorted by market cap (USD)
...
// Fetches detailed data for a single coin (by CoinGecko id like "bitcoin")
...
// Fetches 7-day price history for chart display
